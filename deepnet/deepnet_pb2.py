...
_LAYER_DIST = _descriptor.EnumDescriptor(
  name='Dist',
  full_name='deepnet.Layer.Dist',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COS', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KL', index=3, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_HYPERPARAMS_LABELTYPE = _descriptor.EnumDescriptor(
  name='LabelType',
  full_name='deepnet.Hyperparams.LabelType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='NOLABEL', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ONEOFK', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_LAYER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='loss_factor', full_name='deepnet.Layer.loss_factor', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rep_tied', full_name='deepnet.Layer.rep_tied', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rep_tied_to', full_name='deepnet.Layer.rep_tied_to', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rep_tied_lambda', full_name='deepnet.Layer.rep_tied_lambda', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rep_tied_dist', full_name='deepnet.Layer.rep_tied_dist', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rep_tied_eval_dist', full_name='deepnet.Layer.rep_tied_eval_dist', index=23,
...
_HYPERPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='select_model_using_restricted', full_name='deepnet.Hyperparams.select_model_using_restricted', index=62,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_type', full_name='deepnet.Hyperparams.label_type', index=63,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alternative', full_name='deepnet.Hyperparams.alternative', index=64,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alternative_size', full_name='deepnet.Hyperparams.alternative_size', index=65,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='odd', full_name='deepnet.Hyperparams.odd', index=66,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='map_k', full_name='deepnet.Hyperparams.map_k', index=67,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='map_n', full_name='deepnet.Hyperparams.map_n', index=68,
...
_OPERATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gpu_no', full_name='deepnet.Operation.gpu_no', index=16,
      number=20, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYER.fields_by_name['rep_tied_dist'].enum_type = _LAYER_DIST
_LAYER.fields_by_name['rep_tied_eval_dist'].enum_type = _LAYER_DIST
_LAYER_LOSSFUNCTION.containing_type = _LAYER;
_LAYER_DIST.containing_type = _LAYER;
...
_HYPERPARAMS.fields_by_name['label_type'].enum_type = _HYPERPARAMS_LABELTYPE
...
_HYPERPARAMS_LABELTYPE.containing_type = _HYPERPARAMS;
